...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    if (isGameRunning) {
        ...
        Slash.setVelocity(lastVX, lastVY)
        music.play(music.createSoundEffect(WaveShape.Noise, 1983, 0, 180, 0, 500, SoundExpressionEffect.None, InterpolationCurve.Linear), music.PlaybackMode.UntilDone)
...
info.onScore(20, function () {
    ...
    game.splash("ПОТУЖНО", "ПОПУСТИЛО")
})
sprites.onOverlap(SpriteKind.Attack, SpriteKind.Destructible, function (sprite, otherSprite) {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    ...
    music.play(music.createSoundEffect(WaveShape.Triangle, 1, 528, 225, 0, 500, SoundExpressionEffect.None, InterpolationCurve.Curve), music.PlaybackMode.UntilDone)
...
isGameRunning = false
let TITLE = sprites.create(assets.image`TITLE`, SpriteKind.UI)
TITLE.changeScale(5, ScaleAnchor.Middle)
TITLE.lifespan = 2000
...
mySprite.sayText("fuck all", 2000, false)
pause(2000)
mySprite.setFlag(SpriteFlag.Invisible, true)
if (game.ask("сходити в ліс по гриби?", "A-так B-ні")) {
    isGameRunning = true
    music.stopAllSounds()
    mySprite.setFlag(SpriteFlag.Invisible, false)
    pause(500)
    ...
    pause(1000)
    music.play(music.createSong(assets.song`main theme_happy_long`), music.PlaybackMode.LoopingInBackground)
    ...
    for (let index = 0; index < 20; index++) {
        myEnemy = sprites.create(img`
            ...
            . . . . . b d d 1 1 b . . . . . 
            `, SpriteKind.Enemy)
        tiles.placeOnRandomTile(myEnemy, sprites.castle.tileGrass3)
